...
interface VolumeProfileFiltersProps {
  sector: string;
  industry: string;
  ...
  onMarketCap: (value: VolumeProfileMarketCap) => void;
  onMarketCapBucket: (value: VolumeProfileMarketCapBucket) => void;
...
export function VolumeProfileFilters({
  sector,
  industry,
  industrySubGroup,
  sectorOptions,
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7">
      ...
      <HierarchySelect
        ...
        onChange={(v) => onMarketCap(v as VolumeProfileMarketCap)}
        disabled={disabled}
      />
      <HierarchySelect
        label="Cap Bucket"
        ...
        onChange={(v) => onMarketCapBucket(v as VolumeProfileMarketCapBucket)}
        disabled={disabled}
      />
      <HierarchySelect
        label="Rows"
