...
import { PERIOD_LABELS } from "./PriceTrend.columns";
import { getPeriodColor } from "./PriceTrend.utils";

export interface PriceTrendLegendProps {
  periods: string[];
}

export function PriceTrendLegend({ periods }: PriceTrendLegendProps) {
