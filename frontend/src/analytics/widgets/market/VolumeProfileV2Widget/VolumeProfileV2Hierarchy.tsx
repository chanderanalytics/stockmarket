...
import type { VolumeProfileV2DrillState, VolumeProfileV2Level } from "./VolumeProfileV2.types";

interface Crumb {
  key: string;
  label: string;
  target: VolumeProfileV2Level;
}

const LEVEL_LABEL: Record<VolumeProfileV2Level, string> = {
  sector: "Sectors",
  industry: "Industries",
...
export function VolumeProfileV2Hierarchy({
  drill,
  onSelect,
}: {
  drill: VolumeProfileV2DrillState;
  onSelect: (target: VolumeProfileV2Level) => void;
}) {
