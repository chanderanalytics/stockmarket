"""
Daily Backup Companies Table Script

Simple backup script to create a daily backup of the companies table.
...
def backup_companies_table():
    """Create a daily backup of the companies table"""
    DB_NAME = 'stockdb'
    DB_USER = 'stockuser'
    DB_PASS = 'stockpass'
    DB_HOST = 'localhost'
    ...
    backup_table = f"companies_daily_{today}"
    ...
    cur.execute(f"""
        SELECT tablename 
        FROM pg_tables 
        WHERE tablename LIKE 'companies_daily_%' 
