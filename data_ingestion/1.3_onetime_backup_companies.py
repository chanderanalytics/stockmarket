"""
Backup Companies Table Script (Historical Import)

Simple backup script to create a timestamped backup of the companies table.
Run this after fetching yfinance info (1.2_add_yf_in_companies.py) 
for a complete backup of all companies data including yfinance info.
"""
...
def backup_companies_table():
    ...
    backup_table = f"companies_backup_historical_{timestamp}"
