"""
Backup Indices Table Script (After Daily Updates)

Simple backup script to create a timestamped backup of the indices table.
Run this after fetching latest indices (4.2_daily_indices.py) 
for a complete backup of all indices data.
"""
...
def backup_indices_table():
    ...
    backup_table = f"indices_backup_daily_{timestamp}"
