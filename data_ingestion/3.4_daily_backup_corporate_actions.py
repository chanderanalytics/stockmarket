"""
Backup Corporate Actions Table Script (After Daily Updates)

Simple backup script to create a timestamped backup of the corporate_actions table.
Run this after fetching latest corporate actions (3.2_daily_corporate_actions.py) 
for a complete backup of all corporate actions data.
"""
...
def backup_corporate_actions_table():
    ...
    backup_table = f"corporate_actions_backup_daily_{timestamp}"
